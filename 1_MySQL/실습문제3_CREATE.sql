...
INSERT INTO member(pub_no, pub_name, phone)
VALUES ('1', '프리렉', '032-326-7282');
INSERT INTO member(pub_no, pub_name, phone)
VALUES('2', '프리렉', '02-322-5143');
INSERT INTO member(pub_no, pub_name, phone)
VALUES('3', '프리렉', '02-332-0931');
...
CREATE TABLE member(
		bk_no INT (5),
        bk_title VARCHAR(5) NOT NULL,
		bk_author VARCHAR(5) NOT NULL,
        bk_price INT '13800, 16800, 20000, 27000, 200000'
